...
public class AppInitialization implements ServletContextListener {
        ...
        public void contextInitialized(ServletContextEvent sce) {
                ...
                database.getProducts().add(new Product(1L, "jordan", "black", 1500, 25, ProductCategory.SNEAKER,
                ...
                database.getProducts().add(new Product(2L, "nike", "blue", 3000, 25, ProductCategory.SNEAKER,
                                "https://github.com/mackrineawino/images/blob/main/kaLhgbyOgxU-removebg-preview.png?raw=true"));
                database.getProducts().add(new Product(3L, "boots", "yellow", 1500, 25, ProductCategory.BOOT,
                                "https://github.com/mackrineawino/images/blob/main/6380186684-removebg-preview.png?raw=true"));
                database.getProducts().add(new Product(5L, "stileto", "pink", 2000, 25, ProductCategory.STILETTO,
                                "https://github.com/mackrineawino/images/blob/main/4bc2ab9d886a6e2895b30cd8b4b2e77c-removebg-preview.png?raw=true"));
                database.getProducts().add(new Product(6L, "Doll", "pink", 2500, 25, ProductCategory.DOLL_SHOE,
