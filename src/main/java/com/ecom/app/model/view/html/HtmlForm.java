...
public class HtmlForm {
    public static String form(Class<?> model, String errorMessage) {
        String htmlForm = "<h3 style=\"text-align: center;\">ADD ITEMS</h3>\n";
        if (StringUtils.isNotBlank(errorMessage)) {
            htmlForm += "<p style=\"color: white; background: red; text-align: center;\">" + errorMessage + "</p>\n";
        }
        htmlForm += "<form action=\"./addProduct\" method=\"post\">\n";
