...
public class AppPage implements Serializable {
        ...
        public void renderHtml(HttpServletRequest req, HttpServletResponse resp,
                ...
                print.write("<!DOCTYPE html>" +
                                ...
                                +
                                "body { margin: 0; padding: 0px 50px; font-family: 'Fira Sans', sans-serif; background: white; }"+
                                "</style>" +
                                "</head>" +
                                ...
                                + "<a href=\"./cart\"><img style=\"width: 50px; color: #49A3C8; cursor: pointer; margin: 40px 0px; margin-left: 20px;\" src=\"https://github.com/mackrineawino/images/blob/main/image-removebg-preview%20(3).png?raw=true\"></a>"
                                + "</div>" +
                                "</div>" +
                                 "<h3 style=\" text-align: center; color: #49A3C8; font-size: 30px; margin: 10px 0;\">Hello " + session.getAttribute("username") + " welcome to CoolStuff</h3>" +
                                 "<h3 style=\"text-align: center; margin-top: 20px; margin-left: 20px; font-size: 25px; color: #49A3C8;\">Shop Now</h3>");
